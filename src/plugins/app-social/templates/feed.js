        ...
        <div class="social-feed">
            ${filtering
                ...
                : html`
                      ...
                      ${api.settings.get('social_rich_compose')
                          ? html`<converse-social-compose-rich .model=${el.model}></converse-social-compose-rich>`
                          : html`<converse-social-compose .model=${el.model}></converse-social-compose>`}
                  `}
